...
def main():
    ...
    simulator.export_results_to_csv(str(output_dir), analysis)
    
    # Step 4: Display Executive Summary
    print("\n" + "=" * 80)
    ...
    print(f"   CSV Exports:")
    print(f"     - Distribution: {output_dir}/project_duration_distribution.csv")
    print(f"     - Percentiles: {output_dir}/percentiles_and_buffers.csv")
    print(f"     - Task Criticality: {output_dir}/task_criticality.csv")
    print(f"     - Risk Drivers: {output_dir}/sensitivity_analysis.csv")
    print(f"     - Category Analysis: {output_dir}/category_analysis.csv")
    print(f"     - Scenario Planning: {output_dir}/scenario_planning.csv")
